...
CUSTOMER_SERVICE_DOMAIN = DomainVocabulary(
    ...
    topics=[
        "ticket", "escalation", "resolution", "sla",
        "satisfaction", "feedback", "complaint", "inquiry",
        "refund", "replacement", "warranty", "support_hours",
        "agent_handoff", "self_service", "knowledge_base",
    ],
    categories=[
        "support_request", "billing_issue", "technical_issue",
        "account_issue", "feedback", "complaint", "inquiry",
    ],
    subcategories={
    ...
    intents=[
        "open_ticket", "check_status", "escalate", "request_refund",
        "report_bug", "request_feature", "cancel_subscription",
    ],
    relationship_types=[
        "assigned_to", "escalated_from", "related_to", "duplicate_of",
    ],
)
...
ECOMMERCE_DOMAIN = DomainVocabulary(
    ...
    topics=[
        "cart", "checkout", "inventory", "wishlist",
        "price", "discount", "coupon", "promotion",
        "shipping", "delivery", "tracking", "return",
        "review", "rating", "recommendation", "search",
    ],
    categories=[
    ...
    intents=[
        "add_to_cart", "remove_from_cart", "checkout", "track_order",
        "initiate_return", "apply_coupon", "check_availability",
    ],
    relationship_types=[
        "purchased", "reviewed", "wishlisted", "recommended_for",
    ],
    custom_fields={
...
HEALTHCARE_DOMAIN = DomainVocabulary(
    ...
    topics=[
        ...
        "symptom", "medication", "provider", "insurance",
        "lab_result", "imaging", "referral", "follow_up",
        "vaccination", "wellness", "chronic_condition",
    ],
    categories=[
        "clinical", "administrative", "insurance", "pharmacy", "wellness",
    ],
    subcategories={
    ...
    entity_types=[
        "patient", "provider", "medication", "condition",
        "appointment", "facility", "insurance_plan",
    ],
    intents=[
        "schedule_appointment", "request_prescription", "check_results",
        "verify_coverage", "find_provider", "refill_medication",
    ],
    relationship_types=[
        "treats", "prescribed_by", "diagnosed_with", "referred_to",
    ],
    custom_fields={
...
FINANCE_DOMAIN = DomainVocabulary(
    ...
    topics=[
        "account", "transaction", "transfer", "balance",
        "statement", "payment", "loan", "mortgage",
        "investment", "portfolio", "trading", "dividend",
        "credit", "debit", "interest", "fee",
    ],
    categories=[
        "banking", "investment", "lending", "insurance", "payment",
    ],
    subcategories={
    ...
    entity_types=[
        "account", "transaction", "customer", "security",
        "loan", "card", "beneficiary",
    ],
    intents=[
        "check_balance", "transfer_funds", "pay_bill", "open_account",
        "apply_loan", "dispute_transaction", "set_alert",
    ],
    relationship_types=[
        "owns", "authorized_on", "linked_to", "beneficiary_of",
    ],
    custom_fields={
...
SAAS_DOMAIN = DomainVocabulary(
    ...
    topics=[
        "subscription", "plan", "feature", "usage",
        "api", "integration", "webhook", "sdk",
        "dashboard", "analytics", "report", "export",
        "team", "workspace", "permission", "role",
    ],
    categories=[
        "subscription", "feature", "integration", "support", "account",
    ],
    subcategories={
    ...
    entity_types=[
        "user", "team", "workspace", "subscription", "api_key", "integration",
    ],
    intents=[
        "upgrade_plan", "downgrade_plan", "add_users", "enable_feature",
        "generate_api_key", "configure_integration", "export_data",
    ],
    relationship_types=[
        "member_of", "admin_of", "owns", "has_access_to",
    ],
    custom_fields={
...
HR_DOMAIN = DomainVocabulary(
    ...
    topics=[
        "employee", "applicant", "recruitment", "onboarding",
        "payroll", "benefits", "pto", "leave",
        "performance", "review", "goal", "training",
        "compliance", "policy", "handbook", "offboarding",
    ],
    categories=[
        "recruitment", "employee_data", "payroll", "benefits",
    ...
    entity_types=[
        "employee", "applicant", "position", "department",
        "manager", "team", "document",
    ],
    intents=[
        "apply_job", "request_pto", "submit_timesheet", "view_payslip",
        "enroll_benefits", "update_info", "submit_review",
    ],
    relationship_types=[
        "reports_to", "manages", "member_of", "applied_for",
    ],
)
...
EDUCATION_DOMAIN = DomainVocabulary(
    ...
    topics=[
        ...
        "enrollment", "progress", "instructor", "student",
        "curriculum", "schedule", "material", "discussion",
    ],
    categories=[
        "course", "assessment", "enrollment", "progress", "administration",
    ],
    subcategories={
    ...
    entity_types=[
        "student", "instructor", "course", "lesson", "assessment", "certificate",
    ],
    intents=[
        "enroll_course", "start_lesson", "submit_assignment", "take_quiz",
        "view_grades", "request_certificate", "ask_question",
    ],
    relationship_types=[
        "enrolled_in", "teaches", "prerequisite_of", "assigned_to",
    ],
)
