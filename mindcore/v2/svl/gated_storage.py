...
Example:
    from mindcore.v2.svl import SharedVocabularyLayer, SVLGate
    from mindcore.v2.svl.gated_storage import GatedCLST, GatedFLR
...
class GatedFLR:
    ...
    def query(
        ...
        for memory, score in zip(flr_result.memories, flr_result.scores):
