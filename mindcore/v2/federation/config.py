...
Usage:
    from mindcore.v2.federation.config import (
        FederationConfig,
        create_federation,
        create_agent,
    )
...
from .access_control import AccessLevel, AccessScope
...
from .namespace import MemoryNamespace, NamespaceHierarchy
...
class Federation:
    ...
    def get_agents_in_team(
        ...
        return [
            ...
            if agent.namespace.department == department
            and agent.namespace.team == team
        ]
