...
from mindcore.flr.metadata_feedback import (
...
from mindcore.flr.recall import FLR, Memory, RecallResult
...
class TestContextInjector:
    ...
    def test_feedback_injection_from_feedback(self):
        ...
        from mindcore.svl.llm_providers import FeedbackInjection
    ...
    def test_context_injector_openai(self):
        ...
        from mindcore.svl.llm_providers import ContextInjector, FeedbackInjection
...
class TestGemini3Support:
    ...
    def test_thinking_level_enum(self):
        ...
        from mindcore.svl.llm_providers import ThinkingLevel
    ...
    def test_gemini_config_is_gemini_3(self):
        ...
        from mindcore.svl.llm_providers import GeminiConfig
    ...
    def test_gemini_25_uses_thinking_budget(self):
        ...
        from mindcore.svl.llm_providers import GeminiConfig, ThinkingMode
    ...
    def test_gemini_3_uses_thinking_level(self):
        ...
        from mindcore.svl.llm_providers import GeminiConfig, ThinkingLevel
    ...
    def test_get_recommended_config_gemini3(self):
        ...
        from mindcore.svl.llm_providers import get_recommended_config
