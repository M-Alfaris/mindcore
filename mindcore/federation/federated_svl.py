...
class AggregatedFeedback:
    ...
    def to_injection_format(self) -> dict[str, Any]:
        ...
        return {
            ...
            "low_quality_topics": [
                (t, self.topic_effectiveness.get(t, 0.3)) for t in self.avoid_topics
            ],
            ...
            "low_quality_categories": [
                (c, self.category_effectiveness.get(c, 0.3)) for c in self.avoid_categories
            ],
        }
...
class FederatedSVL:
    ...
    def get_aggregated_feedback(
        ...
        result.preferred_topics = [
            t
            for t, e in result.topic_effectiveness.items()
        ...
        result.preferred_categories = [
            c
            for c, e in result.category_effectiveness.items()
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "feedback_store": {path: fb.to_dict() for path, fb in self.feedback_store.items()},
            "agent_feedback": {agent: fb.to_dict() for agent, fb in self.agent_feedback.items()},
        }
