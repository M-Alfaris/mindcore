...
Example:
    ...
    from mindcore.patterns.customer_facing import UserMemoryHelper
...
if TYPE_CHECKING:
    from mindcore.federation import AgentMemoryBridge
...
class UserMemoryHelper:
    ...
    def recall_for_user(
        ...
        if memory_type:
            results = [
                m for m in results if getattr(m, "metadata", {}).get("memory_type") == memory_type
            ]
...
from mindcore.patterns.customer_facing import mask_pii, contains_pii
...
from mindcore.patterns.customer_facing import consent_to_access_level
