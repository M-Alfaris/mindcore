...
class SignalStore:
    ...
    def get_signal_stats(self, memory_id: str) -> SignalStats:
        ...
        return SignalStats(
            ...
            first_signal_at=datetime.fromisoformat(row["first_at"]) if row["first_at"] else None,
            last_signal_at=datetime.fromisoformat(row["last_at"]) if row["last_at"] else None,
        )
